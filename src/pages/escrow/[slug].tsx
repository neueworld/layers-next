                                    ...
                                    <Box>
                                      ...
                                      <Box>
                                        <Text fontSize="14px">
                                          ...
                                          Authena. The build will be handled
                                          using WebFlow to build an autonomous
                                          team in the future who will handle the
                                          website (primarily to avoid developer
                                          intervention). Integration of
                                          Analytics and SEO structure will be
                                          included.
                                        </Text>
                                        <Text
                        ...
                        >
                          <HStack px="10px" py="30px">
                            ...
                            <HStack color="blue.100">
                              <Image as={NextImage} src={pendIcon} w="12px" />
                          ...
                          <Box px="20px">
                            ...
                            >
                              <HStack w="full" spacing="10px">
                                ...
                                <Image as={NextImage} src={clockIcon} w="16px" />
                              </HStack>
                            </Button>
                          </Box>
                        </HStack>
                        ...
                        >
                          <HStack px="10px" py="30px">
                            ...
                            <HStack color="primary.600">
                              <Image as={NextImage} src={clockIconTwo} w="12px" />
                      ...
                      >
                        ...
                        >
                          <HStack px="10px" py="30px">
                            <Text>05 Apr 2023</Text>
                            <HStack color="primary.400">
                              <Image as={NextImage} src={checkIcon} w="12px" />
                          ...
                          <Box px="20px">
                            <Button rounded={30} px="20px" h="35px">
                              <HStack w="full" spacing="10px">
                                ...
                                <Image as={NextImage} src={checkIcon} w="14px" />
                              </HStack>
                            </Button>
                          </Box>
                        </HStack>
