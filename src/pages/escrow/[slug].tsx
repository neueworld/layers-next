import { ArrowBackIcon, CheckIcon, ChevronDownIcon, CloseIcon, InfoIcon } from "@chakra-ui/icons";
import {
  Button,
  Box,
  CircularProgress,
...
import { IHistory, IMilestone, IWorks, StatusType } from "@/types/contract.types";
...
const Client = () => {
  ...
  useEffect(() => {
    ...
    let rCash = 0;
    let pCash = 0;
    contract?.payment.history?.forEach(({ status, amount }: { status: string; amount: number }) => {
      if (status === "paid") {
        cash += amount;
      }
    ...
    if (user?.address === contract?.author.walletAddress && contract?.author.role === "client") {
      setIsClient(true);
    }
    if (user?.address === contract?.guest.walletAddress && contract?.guest.role === "client") {
      setIsClient(true);
    }
            ...
            <VStack w='20%' pt='30px' spacing='20px'>
                  ...
                  <HStack spacing='15px' pb='6px'>
                    <VStack spacing='2px'>
                      <CircularProgress
                        ...
                        trackColor='grey.100'
                      >
                        <CircularProgressLabel fontSize={18}>${pendingCash}</CircularProgressLabel>
                      </CircularProgress>
                    ...
                    <VStack spacing='2px'>
                      <CircularProgress
                        ...
                        trackColor='grey.100'
                      >
                        <CircularProgressLabel fontSize={18}>${releasedCash}</CircularProgressLabel>
                      </CircularProgress>
                      <Text fontSize='11' textTransform='uppercase'>
                        Released
                      </Text>
              ...
              <VStack align='flex-start' w='full'>
                ...
                <BasicCard variant='dark' w='full'>
                  ...
                  />
                  <StepBox
                    status={contract?.status === StatusType.released ? "active" : "inactive"}
                    isLast
            ...
            <Tabs w='80%' defaultIndex={2}>
              ...
              <TabPanels>
                <TabPanel
                  ...
                  gap='40px'
                >
                  <VStack w='full' align='flex-start' fontSize='14px' spacing='0px'>
                    <Box pl='15px' w='full'>
                      <HStack
                        w='full'
                    ...
                    >
                      <VStack spacing='0px' h='full'>
                        ...
                        <Center w='30px' h='30px' borderRadius='50%' bg='primary.400'>
                      ...
                      <Box pt='40px' w='full'>
                        ...
                        >
                          <Box>
                            ...
                            <Text>
                              Lörem ipsum posedut togände euroläväskap: därför att vid. Teratos
                              fjärrnyckel fastän nonade. Plasotödat nin men dudat jag espegt.
                              Supralärade duska. Prese äsade bess susk. Tresm duguvis, deck antiv
                              autogt. Pos presm för doliga.
                            </Text>
                    ...
                    <HStack w='full' justify='space-between' spacing='10px' align='flex-start'>
                      <VStack spacing='0px'>
                        <Box minH='30px' w='1px' bgColor='grey.400' />
                        <Center w='30px' h='30px' borderRadius='50%' bg='grey.400'>
                          <Image src={document} w='14px' />
                        </Center>
                        <Box minH='100px' w='1px' bgColor='grey.400' />
                      </VStack>
                    ...
                    <HStack w='full' justify='space-between' align='flex-start' spacing='10px'>
                      <VStack spacing='0px'>
                        <Box minH='20px' w='1px' bgColor='grey.400' />
                        <Center w='30px' h='30px' borderRadius='50%' bg='grey.400'>
                          <Image src={document} w='14px' />
                ...
                <TabPanel px='0' w='full'>
                  <BasicCard variant='dark' p={0} pb='10px'>
                    <Box bg='#333333' w='full' borderTopRadius='10px' py='10px' px='20px'>
                      <Text>Terms of Work</Text>
                    </Box>

                    <VStack alignItems='flex-start' p={4} w='100%'>
                      <Text fontWeight='bold' textAlign='left' color='primary.100'>
                        Scope of Work
                      </Text>
                      {contract?.works &&
                      ...
                      <Box color='primary.100'>
                        ...
                        <Text fontSize='14px' color='white'>
                          {contract &&
                            contract?.confidentiality[contract?.confidentiality.length - 1].text}
                        </Text>
                      </Box>
                      ...
                      <Box color='primary.100'>
                        ...
                        <Text fontSize='14px' color='white'>
                          {contract && contract?.termination[contract?.termination.length - 1].text}
                        </Text>
                      </Box>
                      ...
                      <Box color='primary.100'>
                        ...
                        <Text fontSize='14px' color='white'>
                          {contract && contract?.liability[contract?.liability.length - 1].text}
                        </Text>
                      </Box>
                      ...
                      <Box color='primary.100'>
                        ...
                        <Text fontSize='14px' color='white'>
                          {contract && contract?.dispute[contract?.dispute.length - 1].text}
                        </Text>
                      </Box>
                          ...
                          <Table variant='unstyled' w='full'>
                            ...
                            <Tbody>
                              {contract &&
                                ...
                                contract?.payment.milestone.map((m: IMilestone) => {
                                  return (
                                      ...
                                      <Td>
                                        <HStack w='full' spacing='20px'>
                                          <Box>
                                            ...
                                            <Text fontSize='14px'>{m.description}</Text>
                                          </Box>
                                        </HStack>
                                      </Td>
                                      <Td>
                              ...
                              <Tr color='primary.100'>
                                <Td>
                                  <Box>
                                    <Text fontWeight='bold'>Phase 1: Dashboard</Text>
                                    <Text fontSize='14px'>
                                      Redesign for better look and feel as an improved MVP with
                                      utility driven UI and UX. Design will be based on hypothesis &
                                      highly focussed on refining the existing designs.
                                    </Text>
                                  </Box>
                                </Td>
                                <Td>05 Apr 2023</Td>
                              ...
                              <Tr color='primary.100'>
                                <Td>
                                  <Box>
                                    <Text fontWeight='bold'>Phase 2: Educational Website</Text>
                                    <Box>
                                      <Text fontSize='14px'>
                                        Release V1 of the new website with better design;
                                        benchmarking Aura and Authena. The build will be handled
                                        using WebFlow to build an autonomous team in the future who
                                        will handle the website (primarily to avoid developer
                                        intervention). Integration of Analytics and SEO structure
                                        will be included.
                                      </Text>
                                      <Text fontSize='12px' color='primary.400'>
                                        Request for Review
                                ...
                                <Td isNumeric>$200</Td>
                                <Td textAlign='right'>
                                  <Button rounded={30} px='20px' h='35px' bg='primary.400'>
                                    <HStack w='full' spacing='10px'>
                                      <Text fontSize='14px'>WIP</Text>
                                      <ChevronDownIcon w='16px' />
                                    </HStack>
                              ...
                              <Tr color='primary.100'>
                                <Td>
                                  <Box>
                                    <Text fontWeight='bold'>Phase 3: SEO Updates</Text>
                                    <Text fontSize='14px'>
                                      Release V1 of the new website with better design; benchmarking
                                      Aura and Authena. The build will be handled using WebFlow to
                                      build an autonomous team in the future who will handle the
                                      website (primarily to avoid developer intervention).
                                      Integration of Analytics and SEO structure will be included.
                                    </Text>
                                  </Box>
                                </Td>
                                <Td>
                                ...
                                <Td isNumeric>$200</Td>
                                <Td textAlign='right'>
                                  <Button rounded={30} px='20px' h='35px' bg='grey.600'>
                                    <HStack w='full' spacing='10px' color='grey.100'>
                                      <Text fontSize='14px'>Backlog</Text>
                                      <ChevronDownIcon w='16px' />
                                    </HStack>
                                  </Button>
                    ...
                    {contract?.payment.history &&
                      ...
                      contract.payment.history.map(
                        ({
                          ...
                          return (
                            <HStack key={_id} w='full' borderBottomWidth='1px' borderColor='white'>
                              <HStack w='33%' borderRightWidth='1px' borderColor='white'>
                                <Box py='30px' px='10px'>
                                  {description}
                                </Box>
                              </HStack>
                                ...
                                <HStack px='10px' py='30px'>
                                  ...
                                  {status === "paid" ? (
                                    ...
                                    <VStack>
                                      <HStack color='green.400'>
                                        <CheckIcon w='12px' />
                                        <Text fontSize='12px'>Task Completed</Text>
                                      </HStack>
                                      <HStack>
                                    ...
                                    <HStack color='green.400'>
                                      <CheckIcon />
                                      <Text fontSize='12px'>Funds released</Text>
                                    </HStack>
                                  ) : (
                                    <HStack color='blue.200'>
                                      <InfoIcon w='12px' />
                                      <Text fontSize='12px'>Work in Progress</Text>
                                    </HStack>
                                  )}
                                </HStack>
                              </HStack>
                              <HStack w='34%' justify='space-between'>
                                ...
                                <Box px='20px'>
                                  ...
                                  {isClient && status === "unpaid" && (
                                    <Button rounded={30} h='35px' isLoading={isPaying}>
                                      <Web3Button
                                        // type="button"
                                        ...
                                        action={async (smartContract) => {
                                          setIsPaying(true);
                                          console.log(contract.payment.totalFee, fee);
                                          ...
                                          await smartContract
                                            .call(
                                              ...
                                              [
                                                ethers.utils.parseEther(
                                                  String(contract?.payment.totalFee)
                                                ),
                                              ],
                                              {
                                            ...
                                            .catch((err) => {
                                              ...
                                              toast({
                                                title: "Error interacting with contract",
